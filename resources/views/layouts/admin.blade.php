...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
        integrity="sha512-p8f6XYc+f2W46vIf2JqIwOjx6/EeQz0jh9u2QK0Cz7XqFp1fQjEIpTcvlWj1n5jR1+U6Er73j0Tvze4uN2WfQA=="
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ route('admin.index') }}" class="brand-link">
                <img src="https://adminlte.io/themes/v3/dist/img/AdminLTELogo.png" alt="SIPG Logo"
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.komponen-gaji.index') }}"
                                class="nav-link {{ request()->routeIs('admin.komponen-gaji.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.absensi-setting.index') }}"
                                class="nav-link {{ request()->routeIs('admin.absensi-setting.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.absensi-report.index') }}"
                                class="nav-link {{ request()->routeIs('admin.absensi-report.*') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-list-alt"></i>
                                <p>Laporan Absensi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.gaji-report.index') }}"
                                class="nav-link {{ request()->routeIs('admin.gaji-report.*') ? 'active' : '' }}">
