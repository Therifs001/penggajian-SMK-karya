...
<head>
    ...
    <title>@yield('title', 'Guru Panel') | SIPG</title>
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('guru.index') }}" class="nav-link">Dashboard</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{ route('guru.index') }}" class="brand-link">
            ...
            <span class="brand-text font-weight-light">SIPG Guru</span>
        </a>
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">{{ auth()->user()->name ?? 'Guru' }}</a>
                </div>
            </div>
